...
const PreviewPage = () => {
  const { data: metadata = [], error, isLoading } = useSwr<Metadata[]>('https://racers-dev-2.s3.us-east-1.amazonaws.com/2/metadata.json', (url) => fetch(url).then((res) => res.json()));
  console.log(metadata, error, isLoading)
